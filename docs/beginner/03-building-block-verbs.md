...
| --------- | ------------ | ------------------------------- |
| **SER**   | to be        | Who you ARE, what things ARE    |
| **ESTAR** | to be        | Where you ARE, how you FEEL     |
| **IR**    | to go        | Where you GO, future plans      |
| **TENER** | to have      | What you HAVE, age, obligations |
| **HACER** | to do/make   | What you DO, the WEATHER        |
| **HABER** | there is/are | What EXISTS                     |

**Real conversation example:**
"Soy estudiante, estoy en Valencia, voy a clase, tengo amigos, hago ejercicio, y hay mucho que aprender."
...
| Use SER                    | Use ESTAR                       |
| -------------------------- | ------------------------------- |
| Identity (Soy Juan)        | Location (Estoy en casa)        |
| Nationality (Soy español)  | Feelings (Estoy feliz)          |
| Profession (Es doctor)     | Conditions (Está frío)          |
...
**At School:**
"Estamos en la biblioteca. Hay muchos libros aquí. Tenemos que estudiar. Vamos a hacer un proyecto. Es importante. Hace buen tiempo fuera."
